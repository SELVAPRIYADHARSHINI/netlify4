  ...
  return (
    <div className='contact'>
        <div className='contact-col'>
            ...
            <p>எங்களைத் தொடர்புகொள்ள, தயவுசெய்து தொடர்பு படிவத்தை நிரப்பவும் அல்லது கீழே காட்டப்பட்டுள்ள விவரங்களைப் பயன்படுத்தவும். மேலும் பகுப்பாய்வு மற்றும் அறிவை வழங்க நாங்கள் முயற்சிப்பதால் உங்கள் கருத்து, கேள்விகள் மற்றும் பரிந்துரைகளை நாங்கள் பாராட்டுகிறோம்.</p>
            <ul>
        ...
        <div className='contact-col'>
            <form onSubmit={onSubmit}>
                <label>செயலியில் ஏதேனும் தோல்வி ஏற்பட்டால், அந்த வினவலை அனுப்பவும்</label>
                <textarea name='message' rows="3"  required></textarea>
                <label>ஏதேனும் மேம்பாடுகள் தேவை</label>
                <textarea name='message' rows="3"  required></textarea>
