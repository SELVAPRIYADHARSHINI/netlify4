        ...
        <div className='wrapper'>
            <form onSubmit={handleSignup}>
                ...
                <div className="input-box">
                    <input onChange={(e) => { handleCredentials(e) }} type="text" placeholder='பெயர்' required name="name" />
                    <IoPerson className='icon' />
                </div>
                <div className="input-box">
                    <input onChange={(e) => { handleCredentials(e) }} type="text" placeholder='மின்னஞ்சல் முகவரி' required name="email" />
